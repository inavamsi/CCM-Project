...
def main(D):
  # Whole thing in one cell

  #D=[1,2,14,20,21]            # input Data
  noise_mean=0
  noise_var=0.66          # variance of noise, to set variance use first cell as reference
  threshold = 0.99      # for full list set threshold = 1, foronly top elemnt set thrshiold =0
  ...
  top = most_likely_h(Post, threshold)
